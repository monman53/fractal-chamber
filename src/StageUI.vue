...
<template>
    <div id="base">
        ...
        <label>
            simplexResolution: {{ humanReadable(parameter.simplexResolution) }}<br>
            <input type="range" v-model.number="parameter.simplexResolution" :step="0.0001" :min="0.001"
                :max="0.03"><br>
        </label>
        <label>
            simplexTimeScale: {{ humanReadable(parameter.simplexTimeScale) }}<br>
            <input type="range" v-model.number="parameter.simplexTimeScale" :step="0.01" :min="0.0" :max="4"><br>
        </label>
        <label>
